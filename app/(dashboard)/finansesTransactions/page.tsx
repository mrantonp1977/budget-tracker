          ...
          <div className="flex items-center gap-8">           
            <CreateTransactionDialog
              trigger={
                <Button
                  variant={'outline'}
                  className="border-emerald-500 bg-emerald-900 text-white hover:bg-emerald-700 hover:text-white w-[190px]"
                >
                  New income 😀
                </Button>
              }
            ...
            <CreateTransactionDialog
              trigger={
                <Button
                  variant={'outline'}
                  className="border-rose-500 bg-rose-900 text-white hover:bg-rose-700 hover:text-white w-[190px]"
                >
                  New expense 😠
                </Button>
              }
